<template>
  <div class="relative">
    ...
    <div v-if="isOpen" class="fixed right-0 mt-2 py-2 w-48 bg-white rounded-lg shadow-xl">
      <a href="#" class="block px-4 py-1 text-gray-800 hover:bg-teal-500 hover:text-white">Account settings</a>
      <a href="#" class="block px-4 py-1 text-gray-800 hover:bg-teal-500 hover:text-white">Support</a>
      <a href="#" class="block px-4 py-1 text-gray-800 hover:bg-teal-500 hover:text-white">Sign out</a>
    </div>
  </div>
</template>
