    ...
    <nav class="sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between" :class="{ 'hidden': !isOpen, 'block': isOpen }">
      ...
      <div class="sm:flex sm:items-center">
        ...
        <div class="relative px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
          <div class="flex">
            <img class="xl:h-12 xl:w-12 object-cover rounded-full border-2 border-gray-600 sm:h-8 sm:w-8 xl:border-gray-300" src="/img/girl_2.jpg" alt="">
            <span class="ml-4 font-semibold text-gray-200 sm:hidden">Marea Norton</span>
          </div>
